  ...
  return (
    <>
      <div className='cont-news'>
        <p>Lo + Relevante</p>
        <h1>{relevanteDetails.data[0].title}</h1>
      </div>
      ...
      <div className='cont-img'>
        <img src={`${url}/${relevanteDetails.data[0].image}`} alt="Foto 1" style={{ width: '1250px', height: '700px' }} />
      </div>

      <div className='cont-texto'>
        <p>
          {relevanteDetails.data[0].description}
          Descripción
        </p>
      </div>
    </>
